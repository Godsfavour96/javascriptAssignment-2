...
// return all students who are from california

const californiaStudents = utme2024Students. filter(
  student => student.state === "California")

 console.log (californiaStudents)

 // return all female students
...
// return the firstName and score for each student.
 ...
 const results = utme2024Students.map(student => [
  student.firstName, student.score
 ])
